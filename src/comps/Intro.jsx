	...
	<section>
      <div className="container mb-3">
        <div className="container g-0 mt-3" id="intro">
          ...
          <p>I am currently seeking a front-end developer position to utilize my skills in CSS, Javascript, React.js and responsive web design to contribute to innovative projects. Eager to grow and develop in a collaborative team environment while leveraging my foundational knowledge and passion for technology to deliver user-friendly web solutions.</p>
