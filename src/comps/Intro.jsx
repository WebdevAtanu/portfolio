  ...
  <div className="flex flex-col gap-5">
    <div className="flex gap-4 items-center">
      <div className="avatar cursor-pointer">
        <div className="w-32 rounded-full ring ring-offset-0 ring-[#9b24af]">
          <img src="pics/me.jpg" />
        </div>
      </div>
      <div>
        ...
        <h1 className="mb-3 text-3xl tracking-wide">Atanu Mondal</h1>
          ...
          <a href="CV.pdf" target="_blank">
            <div className="flex items-center gap-1 justify-center text-sm text-black px-4 py-2 rounded bg-[#9b24af]">
          ...
          <a href="https://www.linkedin.com/in/atanu-mondal-b98707255/" target="_blank" className='flex items-center'>
              <i className="bi bi-linkedin mx-1 text-lg text-[#9b24af]"></i>
          </a>
          <a href="https://github.com/WebdevAtanu" target="_blank" className='flex items-center'>
              <i className="bi bi-github mx-1 text-lg text-[#9b24af]"></i>
          </a>
        </div>
      </div>
    </div>
