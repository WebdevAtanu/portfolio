    ...
    return (
	    ...
	    ease: "easeInOut"
  		...
  		<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
			<div className='flex md:flex-col gap-4 items-center md:items-start bg-[#091327] p-5'>
			...
			<div className="flex flex-col gap-4 items-center justify-center md:col-span-2 bg-[#091327] p-5">
