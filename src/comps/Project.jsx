...
function Desktop(props) {
    return (
    <motion.div initial={{ y: 50 }} animate={{ y: 0 }} className='bg-[#091327] p-5 rounded-xl flex flex-col gap-5'>
      <h5 className='mb-2 tracking-wider text-lg'>{props.h5}</h5>
      ...
      <div className="flex justify-end gap-3 mt-3 text-sm">
        <a href={props.href} target='_blank' className='bg-blue-800 p-1 rounded hover:bg-blue-900'><i className="bi bi-browser-chrome animate-pulse"></i> Live</a>
        <a href={props.github} target='_blank' className='bg-blue-800 p-1 rounded hover:bg-blue-900'><i className="bi bi-github"></i> GitHub</a>
      </div>
    </motion.div>
    )
}
...
return (
    ...
    <p className='text-center mb-6 text-2xl tracking-wider text-[#f70853]' id='bolder'>Projects</p>
