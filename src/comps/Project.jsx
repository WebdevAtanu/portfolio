...
function Project() {
	...
	<section>
      <div className="container">
        <Desktop href="https://mock-api-ecommerce.netlify.app/" src="pics/site/mockAPI.png" p="It is fake e-commerce book shop website using fake APIs. Also Implemented a login and signup UI, searching and a cart functionality. It also has a customer reviews section" tech={<><span className="techStack">#Bootstrap</span><span className="techStack">#SwiperJS</span><span className="techStack">#FakeAPI</span></>} class1='col-md-6 order-md-2'
        class2='col-md-6 d-flex align-items-center order-md-1'/>

        <Desktop href="https://customtemplate.netlify.app/" src="pics/site/template.png" p="It is a website template browser where the sorce code is provided for download. The codes should include bootstrap cdn to work." tech={<><span className="techStack">#Bootstrap</span><span className="techStack">#Canva</span></>} class1='col-md-6 order-md-1' class2='col-md-6 d-flex align-items-center order-md-2'/>
        ...
        <Desktop href="https://react-dashboard-three-red.vercel.app/" src="pics/site/money.png" p="It's An expense tracker dashboard website. Here users can signup and login themselves. After succesful login the user redirected on the dashboard where data can visualised in chart format." tech={<><span className="techStack">#TailwindCSS</span><span className="techStack">#ReactJS</span><span className="techStack">#Chart JS</span></>} class1='col-md-6 order-md-2'
        class2='col-md-6 d-flex align-items-center order-md-1'/>
