...
function ProjectCard({ h5, tech, p, img1, img2, img3, github, href }) {
  return (
    <motion.div
      ...
      className="bg-[#091327] hover:bg-[#071023] border border-indigo-600 p-5 rounded-xl flex flex-col justify-between gap-5 shadow-lg transition-all duration-300"
    >
  ...
  const projects = [
    {
      ...
      tech: (
        <>
          {" "}
          <span className="techStack">MERN</span>{" "}
          <span className="techStack">ShadCN</span>{" "}
        </>
      ),
    ...
    },
    {
      ...
      tech: (
        <>
          {" "}
          <span className="techStack">Appwrite</span>{" "}
    ...
    },
    {
      ...
      tech: (
        <>
          {" "}
          <span className="techStack">Tailwind CSS</span>{" "}
          <span className="techStack">React.js</span>{" "}
        </>
      ),
    ...
    },
    {
      ...
      tech: (
        <>
          ...
          <span className="techStack">Swiper.js</span>{" "}
          <span className="techStack">FakeAPI</span>{" "}
        </>
      ),
    ...
    },
    {
      ...
      tech: (
        <>
          ...
          <span className="techStack">Tailwind CSS</span>{" "}
          <span className="techStack">React.js</span>{" "}
          <span className="techStack">Chart JS</span>{" "}
        </>
      ),
    ...
    },
    {
      ...
      tech: (
        <>
          ...
          <span className="techStack">React.js</span>{" "}
          <span className="techStack">Datatable</span>{" "}
        </>
      ),
    ...
    },
    {
      ...
      tech: (
        <>
          {" "}
          <span className="techStack">Bootstrap</span>{" "}
          <span className="techStack">Canva</span>{" "}
        </>
      ),
