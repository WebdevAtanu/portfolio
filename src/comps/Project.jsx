...
return (
    <div>
      ...
      <div className="">
        <Desktop href="https://react-dashboard-three-red.vercel.app/" src="pics/site/dashboard.png" h5='Dashboard' p="It's An expense tracker dashboard website. Here users can signup and login themselves. After succesful login they are redirected on the dashboard where data can be visualised in chart format." tech={<><span className="techStack">#Tailwind CSS</span><span className="techStack">#React.js</span><span className="techStack">#Chart JS</span></>}/>
      </div>
