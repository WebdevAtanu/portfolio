...
<section>
  ...
  <div className="container-fluid">
    ...
    <SplideSlide>
    <div className="container py-4">
      <Desktop href="https://lifestyle-ecommerce-project.vercel.app/" src="pics/site/ecommerce.png" h5='Lifestyle E-commerce' p="It's an e-commerce website using React. Also Implemented a login and signup UI, searching and a cart functionality." tech={<><span className="techStack">#Tailwind CSS</span><span className="techStack">#React.js</span></>} class1='col-md-6 order-md-2'
      class2='col-md-6 d-flex align-items-center order-md-1'/>
    </div>
    </SplideSlide>
    <SplideSlide>
    <div className="container py-4">
      <Desktop href="https://oh-kolkata.vercel.app/" src="pics/site/kolkata.png" h5='Hello Kolkata' p="A tour guide of the famous places of my city, Kolkata. Visitors can browse the famous places to visit and know about our bengali culture." tech={<><span className="techStack">#Bootstrap</span><span className="techStack">#React.js</span></>} class1='col-md-6 order-md-1'
      class2='col-md-6 d-flex align-items-center order-md-2'/>
    </div>
    </SplideSlide>
    <SplideSlide>
    <div className="container py-3">
      <Desktop href="https://react-dashboard-three-red.vercel.app/" src="pics/site/money.png" h5='Money Manager' p="It's An expense tracker dashboard website. Here users can signup and login themselves. After succesful login the they are redirected on the dashboard where data can visualised in chart format." tech={<><span className="techStack">#Tailwind CSS</span><span className="techStack">#React.js</span><span className="techStack">#Chart JS</span></>} class1='col-md-6 order-md-2'
      class2='col-md-6 d-flex align-items-center order-md-1'/>
    </div>
    </SplideSlide>
    <SplideSlide>
    <div className="container py-3">
      <Desktop href="https://traveller-one.vercel.app/" src="pics/site/travel.png" h5='Traveller' p="It's a travel blog webpage. Here users can browse places around the world. It also has a paginate functionality for efficiency." tech={<><span className="techStack">#Tailwind CSS</span><span className="techStack">#React.js</span><span className="techStack">#React Router</span></>} class1='col-md-6 order-md-1'
      class2='col-md-6 d-flex align-items-center order-md-2'/>
    </div>
    </SplideSlide>
    <SplideSlide>
  ...
  <div className="container-fluid">
    ...
    <SplideSlide>
    <div className="container py-4">
      <Mobile href="https://react-passgen.netlify.app/" src="pics/site/password.png" h5='Random Password' p="A random password generator using react hooks." tech={<><span className="techStack">#React.js</span><span className="techStack">#React Hooks</span></>} class1='col-md-6 order-md-1'
      class2='col-md-6 d-flex align-items-center order-md-2'/>
    </div>
    </SplideSlide>
    <SplideSlide>
    <div className="container py-3">
      <Mobile href="https://web-note-kappa.vercel.app/" src="pics/site/note.png" h5='Web Notes' p="A note taking app using react router." tech={<><span className="techStack">#React.js</span><span className="techStack">#React Hooks</span><span className="techStack">#React Router</span></>} class1='col-md-6 order-md-2'
      class2='col-md-6 d-flex align-items-center order-md-1'/>
    </div>
    </SplideSlide>
    </Splide>
