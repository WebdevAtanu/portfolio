...
function Desktop(props) {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-5 p-3">
      ...
      <div className='flex flex-col gap-4'>
          ...
          <a href={props.href} target='_blank' className='border border-black p-1 rounded hover:text-white hover:bg-slate-700'><i className="bi bi-browser-chrome"></i> Live Link</a>
          <a href={props.github} target='_blank' className='border border-black p-1 rounded hover:text-white hover:bg-slate-700'><i className="bi bi-github"></i> GitHub Link</a> 
          </div>
      </div>
      </div>
    </>
